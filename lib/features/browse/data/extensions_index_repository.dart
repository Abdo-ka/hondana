...
/// Arabic + English + multi-language ("all"), 18+ entries excluded.
@lazySingleton
class ExtensionsIndexRepository {
  ...
  Future<List<ExtensionInfo>> fetchAll() async {
  ...
  static List<ExtensionInfo> filter(Iterable<ExtensionInfo> all) {
    final list = all
        .where((e) => !e.nsfw && allowedLangs.contains(e.lang))
        .toList()
